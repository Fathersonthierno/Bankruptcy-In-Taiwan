...
This project aims to predict whether or not a company in taiwan will go bankrupt based on different characteristics. Moreover, this hands-on machine learning project also aims to enhance and strenghten my skills in ML.

# Taiwan dataset: Features description
